INSERT INTO querySource (querySourceid,name,shortName,status) VALUES 
	(1,'MarketData by market ID','Closed Market','Closed'),
	(2,'MarketDataAll','Current All Data','Active'),
	(3,'MarketTweetData','Current Tweets','Active'),
	(4,'GetMarketChartData;24 Hours prior to Close','24h Closed','Closed'),
	(5,'GetMarketChartData;24 Hour on an active market','24h Active','Active'),
